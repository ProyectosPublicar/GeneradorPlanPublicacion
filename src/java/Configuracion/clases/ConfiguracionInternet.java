 ...
 */
public class ConfiguracionInternet {
    
    public TipoPagina llevaInternet (List<Configuracion> configuraciones, String idConfiguracion){
        ...
        for (int i=0; i<configuraciones.size();i++){
            ...
            for (int j=0; j<listaPaginas.size();j++){
                ...
                if (tp.getNombre().equalsIgnoreCase(ConstantesTipoPaginas.internetPlan))
                {
                    return tp;
                }
            }
