...
//              Response result = port.getInformationProducts(contractNumber,mostrar_valor, tipoDocumento);
                ...
                System.out.println("contract.getCurrencyIsoCode()->  " + contract.getCurrencyIsoCode().getValue());
                System.out.println("contract.getDiscountValue()->  " + contract.getDiscountValue().getValue());
                System.out.println("contract.getMovementType()->  " + contract.getMovementType().getValue());
                System.out.println("contract.getNetValue()->  " + contract.getNetValue().getValue());
                System.out.println("contract.getSaleDate()->  " + contract.getSaleDate().getValue());
                System.out.println("contract.getSaleValue()->  " + contract.getSaleValue().getValue());
                System.out.println("contract.getTax1Value()->  " + contract.getTax1Value().getValue());
                System.out.println("contract.getTax2Value()->  " + contract.getTax2Value().getValue());
                ...
                System.out.println("agent.getAgentName()-> " + agent.getAgentName().getValue());
                System.out.println("°°°°°°°°°°-AgentInfo°°°°°°°°°°");
                ...
                for (int i = 0; i < prInf.size(); i++) {
                    ...
                    for (int j = 0; j < prInf.get(i).getListType().size(); j++) {
                        ...
                        System.out.println("lsInfo.getClasification()->  " + lsInfo.getClasification().getValue());
                        System.out.println("lsInfo.getCodeinstance()->  " + lsInfo.getCodeInstance().getValue());
                        System.out.println("lsInfo.getFigurationcity()->  " + lsInfo.getFigurationCity().getValue());
                        System.out.println("lsInfo.getFigurationname()->  " + lsInfo.getFigurationName().getValue());
                        System.out.println("lsInfo.getInitials()->  " + lsInfo.getInitials().getValue());
                        System.out.println("lsInfo.getInsercionname()->  " + lsInfo.getInsercionName().getValue());
                        System.out.println("lsInfo.getMacrosection()->  " + lsInfo.getMacrosection().getValue());
                        System.out.println("lsInfo.getNetvalue()->  " + lsInfo.getNetValue().getValue());
                        System.out.println("lsInfo.getNocontent()->  " + lsInfo.getNocontent().getValue());
                        System.out.println("lsInfo.getProductbarcode()->  " + lsInfo.getProductBarCode().getValue());
                        System.out.println("lsInfo.getProductcode()->  " + lsInfo.getProductCode().getValue());
                        System.out.println("lsInfo.getProducteditioncode()->  " + lsInfo.getProductEditionCode().getValue());
                        System.out.println("lsInfo.getProducteditionname()->  " + lsInfo.getProductEditionName().getValue());
                        System.out.println("lsInfo.getProductname()->  " + lsInfo.getProductName().getValue());
                        System.out.println("lsInfo.getProductpartcode()->  " + lsInfo.getProductPartCode().getValue());
                        System.out.println("lsInfo.getProductpartname()->  " + lsInfo.getProductPartName().getValue());
                        System.out.println("lsInfo.getProfession()->  " + lsInfo.getProfession().getValue());
                        for (int k = 0; k < lsInfo.getAdditionalLines().size(); k++) {
                            ...
                            System.out.println("adLinInfo.getLastname1()->  " + adLinInfo.getLastname1().getValue());
                            System.out.println("adLinInfo.getLastname2()->  " + adLinInfo.getLastname2().getValue());
                            System.out.println("adLinInfo.getPhone()->  " + adLinInfo.getPhone().getValue());
                            System.out.println("adLinInfo.getPrefix()->  " + adLinInfo.getPrefix().getValue());
                            System.out.println("adLinInfo.getPrefixType()->  " + adLinInfo.getPrefixType().getValue());
                            System.out.println("adLinInfo.getReferenceCode()->  " + adLinInfo.getReferenceCode().getValue());
                            System.out.println("adLinInfo.getSecondname()->  " + adLinInfo.getSecondname().getValue());
...
//                        lstLsInfo.add(lsInfo);
                    ...
                    for (int j = 0; j < prInf.get(i).getInternetType().size(); j++) {
                        ...
                        System.out.println("intInfo.getCallFreePhone()->  " + intInfo.getCallFreePhone().getValue());
                        System.out.println("intInfo.getClientName()->  " + intInfo.getClientName().getValue());
                        System.out.println("intInfo.getEndDate()->  " + intInfo.getEndDate().getValue());
                        System.out.println("intInfo.getFigurationCity()->  " + intInfo.getFigurationCity().getValue());
                        System.out.println("intInfo.getFigurationName()->  " + intInfo.getFigurationName().getValue());
                        System.out.println("intInfo.getInsercionName()->  " + intInfo.getInsercionName().getValue());
                        System.out.println("intInfo.getLabel1()->  " + intInfo.getLabel1().getValue());
                        System.out.println("intInfo.getLabel2()->  " + intInfo.getLabel2().getValue());
                        System.out.println("intInfo.getMacrosection()->  " + intInfo.getMacrosection().getValue());
                        System.out.println("intInfo.getMainSection()->  " + intInfo.getMainSection().getValue());
                        System.out.println("intInfo.getNetValue()->  " + intInfo.getNetValue().getValue());
                        System.out.println("intInfo.getProductBarCode()->  " + intInfo.getProductBarCode().getValue());
                        System.out.println("intInfo.getProductCode()->  " + intInfo.getProductCode().getValue());
                        System.out.println("intInfo.getProductEditionCode()->  " + intInfo.getProductEditionCode().getValue());
                        System.out.println("intInfo.getProductEditionName()->  " + intInfo.getProductEditionName().getValue());
                        System.out.println("intInfo.getProductName()->  " + intInfo.getProductName().getValue());
                        System.out.println("intInfo.getProductPartCode()->  " + intInfo.getProductPartCode().getValue());
                        System.out.println("intInfo.getProductPartName()->  " + intInfo.getProductPartName().getValue());
                        System.out.println("intInfo.getReferenceCode()->  " + intInfo.getReferenceCode().getValue());
                        System.out.println("intInfo.getReferenceName()->  " + intInfo.getReferenceName().getValue());
                        System.out.println("intInfo.getSponsorSection()->  " + intInfo.getSponsorSection().getValue());
                    ...
                    for (int j = 0; j < prInf.get(i).getAdvertiseType().size(); j++) {
                        ...
                        System.out.println("adInfo.getClientName()->  " + adInfo.getClientName().getValue());
                        System.out.println("adInfo.getFigurationCity()->  " + adInfo.getFigurationCity().getValue());
                        System.out.println("adInfo.getFigurationName()->  " + adInfo.getFigurationName().getValue());
                        System.out.println("adInfo.getHighQuality()->  " + adInfo.getHighQuality().getValue());
                        System.out.println("adInfo.getInsercionName()->  " + adInfo.getInsercionName().getValue());
                        System.out.println("adInfo.getMacrosection()->  " + adInfo.getMacrosection().getValue());
                        System.out.println("adInfo.getNetValue()->  " + adInfo.getNetValue().getValue());
                        System.out.println("adInfo.getProductBarCode()->  " + adInfo.getProductBarCode().getValue());
                        System.out.println("adInfo.getProductCode()->  " + adInfo.getProductCode().getValue());
                        System.out.println("adInfo.getProductEditionCode()->  " + adInfo.getProductEditionCode().getValue());
                        System.out.println("adInfo.getProductEditionName()->  " + adInfo.getProductEditionName().getValue());
                        System.out.println("adInfo.getProductName()->  " + adInfo.getProductName().getValue());
                        System.out.println("adInfo.getProductPartCode()->  " + adInfo.getProductPartCode().getValue());
                        System.out.println("adInfo.getProductPartName()->  " + adInfo.getProductPartName().getValue());
                        System.out.println("adInfo.getPurchase()->  " + adInfo.getPurchase().getValue());
                        System.out.println("adInfo.getReferenceCode()->  " + adInfo.getReferenceCode().getValue());
                        System.out.println("adInfo.getReferenceName()->  " + adInfo.getReferenceName().getValue());
                        System.out.println("adInfo.getSaleTypeDesignNumerRequest()->  " + adInfo.getSaleTypeDesignNumerRequest().getValue());
                        System.out.println("adInfo.getSectionName()->  " + adInfo.getSectionName().getValue());
...
//                        lstAdInfo.add(adInfo);
                    ...
                    for (int j = 0; j < prInf.get(i).getProductionType().size(); j++) {
                        ...
                        System.out.println("proInfo.getClasification()->  " + proInfo.getClasification().getValue());
                        System.out.println("proInfo.getFigurationCity()->  " + proInfo.getFigurationCity().getValue());
                        System.out.println("proInfo.getFigurationName()->  " + proInfo.getFigurationName().getValue());
                        System.out.println("proInfo.getIdPurchase()->  " + proInfo.getIdPurchase().getValue());
                        System.out.println("proInfo.getIdSaleRequest()->  " + proInfo.getIdSaleRequest().getValue());
                        System.out.println("proInfo.getInsercionName()->  " + proInfo.getInsercionName().getValue());
                        System.out.println("proInfo.getMacrosection()->  " + proInfo.getMacrosection().getValue());
                        System.out.println("proInfo.getName()->  " + proInfo.getName().getValue());
                        System.out.println("proInfo.getNetValue()->  " + proInfo.getNetValue().getValue());
                        System.out.println("proInfo.getProductBarCode()->  " + proInfo.getProductBarCode().getValue());
                        System.out.println("proInfo.getProductCode()->  " + proInfo.getProductCode().getValue());
                        System.out.println("proInfo.getProductEditionCode()->  " + proInfo.getProductEditionCode().getValue());
                        System.out.println("proInfo.getProductEditionName()->  " + proInfo.getProductEditionName().getValue());
                        System.out.println("proInfo.getProductName()->  " + proInfo.getProductName().getValue());
                        System.out.println("proInfo.getProductPartCode()->  " + proInfo.getProductPartCode().getValue());
                        System.out.println("proInfo.getProductPartName()->  " + proInfo.getProductPartName().getValue());
                        System.out.println("proInfo.getReferenceCode()->  " + proInfo.getReferenceCode().getValue());
                        System.out.println("proInfo.getReferenceName()->  " + proInfo.getReferenceName().getValue());
                        System.out.println("proInfo.getReferenceType()->  " + proInfo.getReferenceType().getValue());
